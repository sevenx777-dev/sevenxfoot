    ...
    import '../../styles.css'; // Ajustado o caminho para o styles.css, assumindo que está na raiz do projeto
    ...
    const generatePlayer = (teamId: number, teamName: string, position: PlayerPosition, constants: GameConstantsType): Player => {
        ...
        return {
            id: playerIdCounter++, name: `${NAMES[Math.floor(Math.random() * NAMES.length)]} ${FIRST_NAMES[Math.floor(Math.random() * FIRST_NAMES.length)]}`, // Inverti nome e sobrenome para mais variedade
                ...
                <div className="dashboard-card">
                    ...
                    {playerTeam && nextOpponent ? (
                        <div className="next-match-info text-center">
                            ...
                            <ImageWithFallback src={playerTeam.logoUrl} fallback={<Shield size={32} className="text-gray-400" />} className="next-match-team-logo" />
                            ...
                            <div className="next-match-team-section space-y-2">
                            <ImageWithFallback src={nextOpponent.logoUrl} fallback={<Shield size={32} className="text-gray-400" />} className="next-match-team-logo" />
